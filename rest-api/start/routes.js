...
Route.group(() => {
	...
	Route.delete('tareas/:tid/actividades/:id', 'ActividadController.destroy').middleware('auth');
	Route.patch('tareas/:tid/actividades/:id', 'ActividadController.update').middleware('auth');
}).prefix('api/v1/');
